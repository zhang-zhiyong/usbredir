...
void g_coroutine_object_notify(GObject *object,const gchar *property_name)
{
    ...
    if (coroutine_self_is_main()) {
		printf("ifififififififififififififififififififififififififififififififififififififififififififififififififififififififif\n");
        g_object_notify(object, property_name);
    } else {
        printf("elseelseelseelseelseelseelseelseelseelseelseelseelseelseelseelseelseelseelseelseelseelseelse\n");
